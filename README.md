...
<body>
  <div class="title-box">15 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 14.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seventeen-Kidult.mp3');
    ...
    const fullMessage = `Kegagalan itu tidak pernah benar-benar buruk 🌻, asalkan kita bisa mengambil pelajaran darinya 🌈. Terkadang, kegagalan datang untuk mengingatkan bahwa ada cara lain yang lebih baik 🌼, atau mungkin ada sesuatu yang perlu dibenahi terlebih dahulu 🤍. Ia adalah guru yang diam-diam mengajarkan kekuatan dan kebijaksanaan ✨. Jangan biarkan rasa kecewa membuat menyerah 🌷. Dalam setiap kegagalan, ada pelajaran berharga yang akan menemani langkah ke depan 🌿. Karena pada akhirnya, yang penting bukanlah seberapa sering kita jatuh 🚀, tetapi seberapa gigih kita bangkit dan melangkah lagi dengan lebih bijaksana 🤍.`;
